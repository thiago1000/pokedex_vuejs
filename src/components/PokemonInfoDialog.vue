        ...
        <v-card v-if="selected_pokemon" class="px-4">
            <v-container>
                <v-row class="d-flex align-center">
                    ...
                    <v-col cols="12" md="8">
                        <h1 class="text-capitalize">{{ selected_pokemon }}</h1>
                        <PokemonType
                        ...
                        <v-chip label>Height: {{ selected_pokemon.height * 2.54 }} cm</v-chip>
                        <v-chip label class="ml-2">Weight: {{ (selected_pokemon.weight * 0.45359237).toFixed(0) }}kgs</v-chip>
                    </v-col>
                </v-row>
